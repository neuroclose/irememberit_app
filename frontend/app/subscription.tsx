    ...
    try {
      ...
      if (hasOrganization) {
        ...
        try {
          ...
          console.log('[Subscription] Organization subscriptionStatus:', updatedUserData.subscriptionStatus);
        } catch (error: any) {
        ...
        try {
          ...
          console.log('[Subscription] Standalone subscriptionStatus:', updatedUserData.subscriptionStatus);
        } catch (error: any) {
